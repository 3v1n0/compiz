...
static const CompMetadataOptionInfo zoomDisplayOptionInfo[] = {
    ...
    { "zoom_out", "button", 0, zoomOut, 0 },
    { "zoom_in_key", "key", 0, zoomIn, 0 },
    { "zoom_out_key", "key", 0, zoomOut, 0 },
    { "zoom_specific_1", "key", 0, zoomSpecific1, 0 },
    { "zoom_specific_2", "key", 0, zoomSpecific2, 0 },
    { "zoom_specific_3", "key", 0, zoomSpecific3, 0 },
    ...
    { "pan_left", "key", 0, zoomPanLeft, 0 },
    { "pan_right", "key", 0, zoomPanRight, 0 },
    { "pan_up", "key", 0, zoomPanUp, 0 },
    { "pan_down", "key", 0, zoomPanDown, 0 },
    { "fit_to_window", "key", 0, zoomToWindow, 0 },
    { "center_mouse", "key", 0, zoomCenterMouse, 0 },
    { "fit_to_zoom", "key", 0, zoomFitWindowToZoom, 0 },
