...
ccsEmptyContextNew (unsigned int screenNum, const CCSInterfaceTable *object_interfaces)
{
    ...
    if (cPrivate->backend)
	ccsInfo ("Backend     : %s", (*(GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->getName) (cPrivate->backend));
...
ccsFreeBackend (CCSBackend *backend)
{
    ...
    CCSBackendFiniFunc backendFini = (GET_INTERFACE (CCSBackendInterface, backend))->backendFini;

    if (backendFini)
	(*backendFini) (bPrivate->context);
...
ccsSetBackendDefault (CCSContext * context, char *name)
{
	...
	if (strcmp ((*(GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->getName) (cPrivate->backend), name) == 0)
	    return TRUE;
...
{
    (*(GET_INTERFACE (CCSBackendInterface, backend))->executeEvents) (flags);
}

Bool ccsBackendInit (CCSBackend *backend, CCSContext *context)
{
    return (*(GET_INTERFACE (CCSBackendInterface, backend))->backendInit) (context);
}

Bool ccsBackendFini (CCSBackend *backend, CCSContext *context)
{
    return (*(GET_INTERFACE (CCSBackendInterface, backend))->backendFini) (context);
}
...
{
    return (*(GET_INTERFACE (CCSBackendInterface, backend))->readInit) (context);
}
...
{
    (*(GET_INTERFACE (CCSBackendInterface, backend))->readSetting) (context, setting);
}
...
{
    return (*(GET_INTERFACE (CCSBackendInterface, backend))->readDone) (context);
}
...
{
    return (*(GET_INTERFACE (CCSBackendInterface, backend))->writeInit) (context);
}
...
{
    (*(GET_INTERFACE (CCSBackendInterface, backend))->writeSetting) (context, setting);
}
...
{
    return (*(GET_INTERFACE (CCSBackendInterface, backend))->getSettingIsIntegrated) (setting);
}
...
{
    return (*(GET_INTERFACE (CCSBackendInterface, backend))->getSettingIsReadOnly) (setting);
}
...
{
    return (*(GET_INTERFACE (CCSBackendInterface, backend))->getExistingProfiles) (context);
}
...
{
    return (*(GET_INTERFACE (CCSBackendInterface, backend))->deleteProfile) (context, name);
}
...
ccsProcessEventsDefault (CCSContext * context, unsigned int flags)
{
    ...
    CCSBackendExecuteEventsFunc executeEvents = (GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->executeEvents;
...
ccsReadSettingsDefault (CCSContext * context)
{
    ...
    CCSBackendReadSettingFunc readSetting = (GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->readSetting;

    if (!readSetting)
	return;

    CCSBackendReadInitFunc readInit = (GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->readInit;
    ...
    CCSBackendReadDoneFunc readDone = (GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->readDone;
...
ccsReadPluginSettingsDefault (CCSPlugin * plugin)
{
    ...
    while (sl)
    {
	(*readSetting) (ccsPluginGetContext (plugin), sl->data);
	sl = sl->next;
    }
...
ccsWriteSettingsDefault (CCSContext * context)
{
    ...
    CCSBackendWriteInitFunc writeInit = (GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->writeInit;
    ...
    CCSBackendWriteDoneFunc writeDone = (GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->writeDone;
...
ccsGetExistingProfilesDefault (CCSContext * context)
{
    ...
    CCSBackendGetExistingProfilesFunc getExistingProfiles = (GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->getExistingProfiles;
...
ccsDeleteProfileDefault (CCSContext * context, char *name)
{
    ...
    CCSBackendDeleteProfileFunc deleteProfile = (GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->deleteProfile;
...
Bool ccsSettingGetIsIntegratedDefault (CCSSetting *setting)
{
    ...
    CCSBackendGetSettingIsIntegratedFunc getSettingIsIntegrated = (GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->getSettingIsIntegrated;
...
Bool ccsSettingGetIsReadOnlyDefault (CCSSetting *setting)
{
    ...
    CCSBackendGetSettingIsReadOnlyFunc getSettingIsReadOnly = (GET_INTERFACE (CCSBackendInterface, cPrivate->backend))->getSettingIsReadOnly;
