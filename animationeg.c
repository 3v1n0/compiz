...
AnimEffect AnimEffectExample1	= &(AnimEffectInfo) {};
AnimEffect AnimEffectExample2	= &(AnimEffectInfo) {};
...
initEffectProperties (AnimEgDisplay *ad)
{
    ...
    memcpy ((AnimEffectInfo *)AnimEffectExample1, (&(AnimEffectInfo)
	{"animationeg:Example Effect 1",
    ...
    memcpy ((AnimEffectInfo *)AnimEffectExample2, (&(AnimEffectInfo)
	{"animationeg:Example Effect 2",
	 {TRUE, TRUE, TRUE, FALSE, FALSE},
	 {.prePaintWindowFunc		= addonFunc->polygonsPrePaintWindow,
	  .postPaintWindowFunc		= addonFunc->polygonsPostPaintWindow,
	  .animStepFunc			= addonFunc->polygonsAnimStep,
