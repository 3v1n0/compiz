...
gsettings=Gio.Settings(schema="org.compiz.core", path="/org/compiz/profiles/mate/plugins/core/")
...
p = Popen(['dconf', 'load', '/org/compiz/profiles/mate/plugins/core/'], stdout=PIPE, stdin=PIPE, stderr=STDOUT)
