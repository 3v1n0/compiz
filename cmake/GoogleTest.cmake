...
if (GMOCK_INCLUDE_DIR)
    ...
    set (GMOCK_SRC_DIR CACHE PATH "Path to Google Mock Sources" ${GMOCK_INCLUDE_PREFIX}/src/gmock)
    set (GMOCK_INCLUDE_DIR CACHE PATH "Path to Google Mock Headers" ${GMOCK_INCLUDE_DIR})
    set (GTEST_INCLUDE_DIR CACHE PATH "Path to Google Test Headers" ${GMOCK_SRC_DIR}/gtest/include)

    set (GMOCK_LIBRARY CACHE STRING "Name of the Google Mock library" gmock)
    set (GMOCK_MAIN_LIBRARY CACHE STIRNG "Name of the Google Mock main () library" gmock_main)
