...
# Create compiz_discover_gtest_tests target

set (COMPIZ_DISCOVER_GTEST_TARGETS_SRC
"#include <map>
#include <vector>
#include <string>
#include <istream>
...
function (compiz_discover_tests EXECUTABLE)
    if (NOT COMPIZ_DISCOVER_TESTS_GENERATED)
	# We really should be using add_custom_command here
	# but in reality GNU Make ensures that this is just
	# another whole world of hurt
	file (WRITE ${CMAKE_BINARY_DIR}/compiz_discover_gtest_tests.cpp ${COMPIZ_DISCOVER_GTEST_TARGETS_SRC})

	add_executable (compiz_discover_gtest_tests
			EXCLUDE_FROM_ALL
			${CMAKE_BINARY_DIR}/compiz_discover_gtest_tests.cpp)
	set (COMPIZ_DISCOVER_TESTS_GENERATED TRUE)

	set_target_properties (compiz_discover_gtest_tests PROPERTIES
			       RUNTIME_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR})
    endif (NOT COMPIZ_DISCOVER_TESTS_GENERATED)
    ...
    add_custom_command (TARGET ${EXECUTABLE}
			POST_BUILD
			COMMAND ${CMAKE_CURRENT_BINARY_DIR}/${EXECUTABLE} --gtest_list_tests | ${CMAKE_BINARY_DIR}/compiz_discover_gtest_tests ${CMAKE_CURRENT_BINARY_DIR}/${EXECUTABLE}
			WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
