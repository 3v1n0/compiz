...
typedef enum
{
    ...
    ANIM_SCREEN_OPTION_HELIX_SPIN_DIRECTION,
    ...
    ANIM_SCREEN_OPTION_LEAFSPREAD_TESSELLATION,
    ...
    ANIM_SCREEN_OPTION_SHATTER_NUM_TIERS,
    ANIM_SCREEN_OPTION_SHATTER_NUM_SPOKES,
    ANIM_SCREEN_OPTION_SHATTER_THICKNESS,
